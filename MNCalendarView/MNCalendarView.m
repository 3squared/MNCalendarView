...
- (NSIndexPath *)indexPathForDate:(NSDate *)date
{
    ...
    NSDateComponents *toDateComp = [self.calendar components:(NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay) fromDate:date];
    ...
    [toDateComp setDay:1];
    toDateComp = [self.calendar components:(NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekday) fromDate:[self.calendar dateFromComponents:toDateComp]];
